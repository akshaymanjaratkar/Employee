...
<nav class="navbar navbar-default navbar-fixed-top">
 ...
 <li><a href="Profile.jsp">HOME</a></li>
  ...
  <div class="dropdown-content">
    <a href="Loginout">Add Employee</a>
...
<div class='container'>
 	<table class="table table-bordered table-striped">
				<tr><th>Employe-Id </th><th>FullName</th><th>Password </th><th>Email</th><th>Update</th><th>Delete</th>	
   <%
			try{
				...
				for (Employee e : list) {%>
					...
					<td><%=e.getEmail()%></td>
						...
						<td ><a href="UpdateEmpAdmin.jsp?eid=<%=e.getEid()%>">Update</a> </td>
					
					
						<td><a href="DeleteEmp?email=<%= e.getEid()%>">Delete</a> </td>
					</tr> 
