            ...
            <legend> New Company Details</legend>       
                    ...
                    <fieldset>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" name="doj" value="<%=e.getDoj()%>">
                        </div>
    ...
    <!-- <div data-role="collapsible">
      <h1>Salary breakup</h1> -->
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="basic" placeholder="Enter Besic Salary" id="weight1" onblur="calculateForm();" value="<%=e.getBasic()%>">
                        </div>
                        
                        
                        <div class="form-group col-md-6">
                            <label for="">HRA</label>
                            <input type="text" class="form-control" name="hra"  placeholder="Enter HRA" id="weight2" onblur="calculateForm();" value="<%=e.getHra()%>">
                        </div>
                        
                        <div class="form-group col-md-6">
                            <label for="">EWW</label>
                            <input type="text" class="form-control" name="eww" placeholder="Enter EWW" id="weight3" onblur="calculateForm();" value="<%=e.getEww()%>">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="">Total</label>
                            <input type="text" class="form-control" name="totalsal"   id="weightTotal" value="<%=e.getTotalsal()%>">
                        </div>
           ...
           <div class=" form-group col-md-6 ">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="email" class="form-control" name="email" id="" value="<%=e.getEmail()%>" >
                        </div>
